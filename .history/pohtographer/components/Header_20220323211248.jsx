...
function Header() { 
  ...
  return ( 
    ...
    <div className={styles.headerLinks}> 
        ...
        <Link href="/">
          <a className={router.pathname == "/" ? styles.active : ""}><span className='desktopVersion'>Home</span> 
        ...
        <Link href="/Contact">
          ...
          <span className='desktopVersion'>Contact</span> </a>
        <a  className={router.pathname == "/Contact" ? styles.active : ""}> <span className='mobileVersion'>  
