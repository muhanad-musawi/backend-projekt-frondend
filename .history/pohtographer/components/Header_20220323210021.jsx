...
function Header() { 
  ...
  return ( 
    ...
    <li>
      ...
      <li>
        <Link href="/Services">
          <a className={router.pathname == "/Services" ? styles.fontRed  : ""}> 
      ...
      <li>
        <Link href="/Photography">
          <a className={router.pathname == "/Photography" ? styles.fontRed  : ""}> 
      ...
      <li>
        <Link href="/Contact">
          <a className={router.pathname == "/Contact" ? styles.fontRed  : ""}> 
