...
function Header() { 
  ...
  return ( 
    ...
    <div className={styles.headerLinks}> 
        ...
        <Image className={styles.img} width={40} height={40} src={home} alt="home" />
        ...
        <Image className={styles.img} width={40}   height={40} src={about} alt="home" />
        ...
        <Image className={styles.img} width={40}  height={40}  src={service} alt="home" />
        ...
        <Image className={styles.img} width={40} src={home} alt="home" />
        ...
        <Image className={styles.img} width={40} src={contact} alt="contact" />
