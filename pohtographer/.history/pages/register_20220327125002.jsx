 ...
 <input type="pass" name="adminPassword" placeholder='Admin Password' value={inputs.adminPassword} size="30" minLength="10" maxLength="25" onChange={handleInputChange}></input>  
