 ...
 <input type="text" name="adminPassword" placeholder='Admin Password' value={inputs.adminPassword} size="30" minLength={10} maxLength="50" onChange={handleInputChange}></input>  
