...
function Register() {   
 ...
 const RECORDS_PATH = BACKEND_URL + '/records/new'
   ...
   return (  
    ...
    <input type="text" name="adminName"  id="adminName" placeholder='Benutzername' value={inputs.title} size="30" maxLength="50" onChange={handleInputChange}></input>   
   
    <label for="adminPassword">Passwort<span>*</span></label>
    <input type="password" name="adminPassword"  id="adminPassword" placeholder='Passwort' value={inputs.title} size="30" maxLength="10" onChange={handleInputChange}></input>  
