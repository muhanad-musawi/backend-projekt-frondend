 ...
 const REGISTER_PATH = BACKEND_URL + '/login/admin/register'
   ...
   .then((response) => {
    if (response.status !== 200) { 
      ...
      router.push({pathname:'/registerSucce'});
 ...
 <input type="password" name="adminPassword" placeholder='Admin Password' value={inputs.adminPassword} size="30" minLength="10" maxLength="25" onChange={handleInputChange}></input>  
