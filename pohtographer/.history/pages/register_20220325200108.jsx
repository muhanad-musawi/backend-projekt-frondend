...
function Register() {   
 ...
 const REGISTER_PATH = BACKEND_URL + '/login/admin/register'
   ...
   return (  
    ...
    <input type="text" name="adminName" placeholder='cover link' value={inputs.adminName } size="30" onChange={handleInputChange}></input>  

<input type="text" name="adminPassword" placeholder='Title' value={inputs.adminPassword} size="30" maxLength="50" onChange={handleInputChange}></input>  
